...
spec:
  ...
  - command:
    ...
    - --audit-policy-file=/etc/kubernetes/auditing/rules/rules.yaml
    - --audit-log-path=/etc/kubernetes/auditing/logs/logs.txt
    ...
    - mountPath: /usr/share/ca-certificates
      ...
      readOnly: true
    - mountPath: /etc/kubernetes/auditing/rules
      name: audit
      readOnly: true
    - mountPath: /etc/kubernetes/auditing/logs
      name: audit-log
      readOnly: false
  hostNetwork: true
  priority: 2000001000
  ...
  - name: audit
    hostPath:
      path: /etc/kubernetes/auditing/rules
      type: File
  - name: audit-log
    hostPath:
      path: /etc/kubernetes/auditing/logs
      type: DirectoryOrCreate
  - hostPath:
